...
import { FaCodeFork } from "react-icons/fa6"; // Assuming this import is intentional
import { formatDate } from "../utils/functions";
import { PROGRAMMING_LANGUAGES } from "../utils/constants";
import toast from "react-hot-toast";

const Repo = ({ repo }) => {
  // Perform a null/undefined check for repo.htm before accessing _url
  const href = repo.htm ? repo.htm._url : "#"; // Set a default href if repo.htm is null/undefined
  ...
  return (
    <li className="mb-10 ms-7">
      ...
      <div className="flex gap-2 items-center flex-wrap">
        <a
          href={href} // Use the calculated href value
          target="_blank"
          rel="noreferrer"
